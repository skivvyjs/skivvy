...
module.exports = function(options) {
	...
	var api = this;
	return getPackageConfig(packageName, environmentName, shouldExpandPlaceholders, api, projectPath);
};

function getPackageConfig(packageName, environmentName, shouldExpandPlaceholders, api, projectPath) {
