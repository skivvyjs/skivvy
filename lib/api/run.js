...
function run(task, api, projectPath, config) {
	...
	function runNamedTask(taskId, api, projectPath, config) {
		...
		try {
			...
			taskConfig = loadTaskConfig(taskName, targetName, packageName, api, projectPath, config);
		} catch (error) {
		...
		function loadTaskConfig(taskName, targetName, packageName, api, projectPath, customConfig) {
			...
			var extendedTargetsConfig = targetsConfig.map(function(targetConfig) {
				var context = getTaskConfigOverrideContext(targetConfig, packageName, api, projectPath);
			...
			function getTaskConfigOverrideContext(taskConfig, packageName, api, projectPath) {
